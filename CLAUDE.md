...
- Ménage du jour : ligne compacte sous la date (1 personne + ses tâches, week-end « ensemble »), tactile → écran de détail plein écran ; les arches deviennent tactiles aussi (détails agenda/sport/ciné, en cours d'implémentation)
